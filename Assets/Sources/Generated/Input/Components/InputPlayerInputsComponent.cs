...
public partial class InputEntity {
    ...
    public void AddPlayerInputs(System.Collections.Generic.List<PlayerInputRecord> newInputRecords) {
    ...
    public void ReplacePlayerInputs(System.Collections.Generic.List<PlayerInputRecord> newInputRecords) {
        var index = InputComponentsLookup.PlayerInputs;
        var component = CreateComponent<PlayerInputsComponent>(index);
        component.inputRecords = newInputRecords;
